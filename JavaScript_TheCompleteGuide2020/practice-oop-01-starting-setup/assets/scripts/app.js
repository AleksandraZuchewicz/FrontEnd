...
class Tooltip extends Component {
    ...
    create() {
        ...
        const tooltiTemplate = document.getElementById("tooltip");
        const tooltipBody = document.importNode(tooltiTemplate.content, true);
...
class App {
    ...
    static startAnalitics() {
        ...
        analitics.src = "assets/scripts/analitic.js";
        analitics.defer = true;
        document.head.append(analitics);
    }
}
